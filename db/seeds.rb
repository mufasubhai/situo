...
u5 = User.create!(
  ...
  password: 'hunter2',
  photo_url: '',
  bio: 'A couple of cute cats just looking to take over the world. We have a wide variety of interests, including, but not limited to: naps, treats, naps, meow, meow, meow, meow...'
)
